            ...
            <div className="overflow-x-auto min-w-[700px]">
              <table className="w-full">
                <thead className="bg-gray-100 border-b border-gray-200">
                  <tr className="bg-primary-50 border-b border-gray-200 font-extrabold text-primary-500 text-left text-xs capitalize tracking-wider">
              ...
              <table className="w-full">
                <tbody className="bg-white divide-y divide-gray-100 text-text-body text-md font-medium leading-5 tracking-tight">
                  {promotions.map((promotion) => (
                    <tr
                      onClick={() => router.push(`/dashboardAdmin/more/promotions/${promotion._id}`)}
                      tabIndex={1}
                      key={promotion._id}
                    ...
                    >
                      ...
                      <td className="w-50 max-w-50 pl-2 py-4 whitespace-nowrap">
                        {new Date(promotion.createdAt).toDateString()}
                      </td>
                      <td className="w-50 max-w-50 pl-2 py-4 whitespace-nowrap">
