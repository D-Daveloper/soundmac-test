...
const ReleaseTable = ({
  ...
  const getStatusBadge = (status: AdminRelease["releaseStatus"]) => {
    const styles = {
      ...
      rejected: "bg-red-100 text-red-700 border-red-200", // Standardized to soft red
    };
  ...
  return (
    <div className="w-full bg-gray-50 md:p-2">
            ...
            <table className="w-full border-collapse text-left text-sm">
              ...
              <thead className="bg-gray-100 sticky top-0 z-10 border-b border-gray-200 shadow-[0_1px_0_0_rgba(229,231,235,1)]">
                <tr className="bg-primary-50 font-bold text-primary-500 text-xs capitalize tracking-wider">
                  ...
                  <th className="p-4 min-w-[140px] uppercase">ISRC</th>
                  <th className="p-4 min-w-[140px] uppercase">UPC</th>
                  <th className="p-4 min-w-[160px]">Release Date</th>
              ...
              <tbody className="bg-white divide-y divide-gray-100 text-gray-700 font-medium">
                {releases.map((release) => (
                  ...
                  >
                    ...
                    {/* Catalog Number */}
                    <td
                      className="p-4 whitespace-nowrap font-mono text-xs text-gray-500 truncate max-w-[140px]"
                      onClick={() => handleCopy(String(release.catalogNumber))}
                      title="click to copy catalog number"
                    >
                      {release.catalogNumber || "N/A"}
                    </td>
