...
import type { FeaturedArtist, Performer, Producer, SongForm, SongWriter } from "@/app/type";
...
const SongForm = () => {
  ...
  // };
  return (
    <div className="bg-main-white h-full w-full flex flex-col justify-between">
      <button
        onClick={() => {
          deleteParam("type");
        }}
          ...
          <div>
            ...
            <div>
              ...
              <div className="w-full flex flex-wrap justify-between gap-y-10 mb-5">
                ...
                <div className="flex flex-col w-[40%] max-sm:w-full">
                  <p className=" capitalize font-medium sm:text-sm text-lg">Release Date</p>
                  {/* <Input
      ...
      <div className="bg-[#F0F0E7] border border-neutral-100 flex justify-end items-center gap-5 h-20 pr-10">
        <button className="font-bold text-sm rounded-lg  px-4 py-2.5 hover:bg-primary/20 border-3 border-primary text-main-heading flex">
          {" "}
          Save as Draft
        </button>
        <button className="font-bold text-sm rounded-lg  px-4 py-2.5 hover:bg-primary/20 border-3 border-primary text-main-heading flex">
