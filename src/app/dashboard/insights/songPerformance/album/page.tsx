...
import {
  useGetPaginatedAlbumPerformance,
...
const Page = () => {
  ...
  useEffect(() => {
    dashboardContext?.setLayoutHeaderMessage("Album Performance");
  }, [dashboardContext]);
  ...
  return (
    <div className="bg-main-white min-h-screen w-full flex flex-col lg:pl-[305px] px-10">
      <div className="flex gap-3 mt-5">
        <Link
          href={"/dashboard/insights/songPerformance/song"}
          type="button"
          className={
            "px-5 py-2 font-bold rounded-xl text-center max-w-fit hover:cursor-pointer hover:bg-primary-500/10 text-sm border-2 border-text-disable text-text-disable"
          }
        >
          Songs
        </Link>
