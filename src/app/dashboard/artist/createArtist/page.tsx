...
const CreateArtistForm = () => {
  ...
  // useEffect(() => {
  //   dashboardContext?.setHeader({title: "Create Artist" , showBackButton:false, onBack:() => router.back()});
  // }, []);
              ...
              <div>
                ...
                <div className="flex w-fit gap-2 items-center mb-5">
                  <input
                    ...
                    onChange={handleChange}
                  />
                  <p className="leading-6 text-xs md:text-sm font-medium">
                    Do you have existing Platform IDs from another distributor?
                  </p>
                </div>
                {/* </div> */}
          ...
          <div className="flex-1 overflow-auto flex flex-col gap-8 px-4 pb-4 h-[64dvh] scrollbar-thin">
            ...
            <div>
              ...
              <div className="w-full flex flex-col gap-2 mt-6">
                ...
                <div className="max-w-md w-full p-3 rounded-xl border border-neutral-100 bg-neutral-50/50 flex items-center gap-4 transition-all">
                  {image ? (
                    <>
                      <div className="relative w-16 h-16 sm:w-20 sm:h-20 shrink-0 rounded-lg overflow-hidden border border-neutral-200 bg-white">
                        <Image
                          src={image}
                          fill
