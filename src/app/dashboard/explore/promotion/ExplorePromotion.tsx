...
import BoomPlayForm from "./BoomPlayForm";
import OnlinePressForm from "./OnlinePressForm";
import PitchPlayForm from "./PitchPlayForm";
import RadioPromotionForm from "./RadioPromotionForm";
const promotionTypes = ["onlinepress","pitchplay","radio","boomplay"];
const ExplorePromotion = () => {
  ...
  return (
    <div className="max-w-[2000px] mx-auto">
      ...
      {(!promotionType || !(promotionTypes.includes(promotionType as string)) && page === "explore") &&
        <>
          ...
          <div className="w-full h-full grid grid-cols-2 max-sm:grid-cols-1 items-center justify-center gap-5 mb-30">
            <button
              onClick={() => setParam("promotionType", "boomplay")}
            ...
            <button
              onClick={() => setParam("promotionType", "radio")}
              className="border-2 border-neutral-100 bg-neutral-50 w-fit max-w-[550px] max-h-[400px] flex flex-col items-center rounded-lg gap-5"
            >
              {/* <div> */}
              <Image
            ...
            <button
              onClick={() => setParam("promotionType", "pitchplay")}
              className="border-2 border-neutral-100 bg-neutral-50 w-fit max-w-[550px] max-h-[400px] flex flex-col items-center rounded-lg gap-5"
            >
              {/* <div> */}
              <Image
            ...
            <button
              onClick={() => setParam("promotionType", "onlinepress")}
              className="border-2 border-neutral-100 bg-neutral-50 w-fit max-w-[550px] max-h-[400px] flex flex-col items-center rounded-lg gap-5"
            >
              {/* <div> */}
              <Image
