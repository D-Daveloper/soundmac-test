...
export const pricing: PricingObjects[] = [
    {
        popular: false, bigBox: false, title: 'Emerging Artist', subTitle: 'Perfect for starters with occasional release', price: '$9.99', prompt: 'Get Started',
        features: [
            'Free audio file converter (Upload any audio format)', '2 Songs distribution Yearly', 'You keep 85% Royalty', 'Free UPC & ISRC', 'YouTube content ID', 'Payment direct to your bank account', 'Spotify verified artist check mark', 'Apple Music Artist verification', 'Release in within 14 days'
        ],
        plan:"Emerging_Artist"
    },

    {
        ...
        plan:"Independent_Artist"
    },

    {
        popular: false, bigBox: false, title: 'Indie label', subTitle: 'Register for up to 10 multiple artist accounts', price: '$69.99', prompt: 'Get Started',
        features: [
